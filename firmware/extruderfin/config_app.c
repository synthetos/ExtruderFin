...
const cfgItem_t cfgArray[] PROGMEM = {
	...
	{ "sys", "hp", _f07, 0, hw_print_hp, get_flt,   set_flt,  (float *)&cs.hw_platform,HARDWARE_PLATFORM },
	{ "sys", "hv", _f07, 0, hw_print_hv, get_flt,   hw_set_hv,(float *)&cs.hw_version, HARDWARE_VERSION },
