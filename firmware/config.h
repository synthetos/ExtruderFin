...
stat_t _get_nul(cmdObj_t *cmd);		// get null value type
stat_t _get_ui8(cmdObj_t *cmd);		// get uint8_t value
stat_t _get_int(cmdObj_t *cmd);		// get uint32_t integer value
stat_t _get_dbl(cmdObj_t *cmd);		// get double value

stat_t _set_nul(cmdObj_t *cmd);		// set nothing (no operation)
stat_t _set_ui8(cmdObj_t *cmd);		// set uint8_t value
stat_t _set_int(cmdObj_t *cmd);		// set uint32_t integer value
stat_t _set_dbl(cmdObj_t *cmd);		// set double value

stat_t _set_grp(cmdObj_t *cmd);		// set data for a group
stat_t _get_grp(cmdObj_t *cmd);		// get data for a group
